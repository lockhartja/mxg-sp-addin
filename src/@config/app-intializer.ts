...
// import { basicNavStructure, aagtNavStructure } from './nav-configurator';
...
//             if (!isPlanner && aagtGroup.children) {
...
//             const spoContext = new SP.ClientContext(
//                 'https://usaf.dps.mil/teams/5MXG-WM/striker-app',
//             );
