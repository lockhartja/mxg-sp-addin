...
//         if (!this.http) {
//             throw new Error(
//                 'Unable to locate angular http module for ajax adapter'
//             );
//         }
...
//             const reqHeaders = core.extend(
//                 {},
//                 (this.defaultSettings as any).headers
//             ); // copy default headers 1st
...
//             throw new Error(
//                 this.name +
//                     ' does not support JSONP (jQuery.ajax:crossDomain) requests'
//             );
//         }
...
//                         ('application/json; charset=utf-8' as any)
//                 );
//             }
//         }
