...
class OnlineAddinOnly extends OnlineResolver_1.OnlineResolver {
    ...
    getAuth() {
        ...
        console.trace(sharepointhostname);
    ...
    InitEndpointsMappings() {
        this.endpointsMappings.set(HostingEnvironment_1.HostingEnvironment.Production, 'login.microsoftonline.us');
        ...
        this.endpointsMappings.set(HostingEnvironment_1.HostingEnvironment.USDefence, 'login.microsoftonline.us');
        this.endpointsMappings.set(HostingEnvironment_1.HostingEnvironment.USGovernment, 'ogin.microsoftonline.us');
        console.trace('endpoint set');
    }
    getAuthUrl(realm) {
